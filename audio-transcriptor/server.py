    ...
    if client:
        try:
            gpt_prompt = (
                ...
                f'Нельзя добавлять новый текст от себя, за исключением '
                f'случаев, когда очевидно, что пропущено какое-то слово '
                f'(или несколько) из-за несовершенства '
                f'технологии распознавания речи. '
